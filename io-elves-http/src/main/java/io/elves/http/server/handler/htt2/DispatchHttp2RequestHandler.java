...
import static io.elves.common.util.Http2Util.firstValue;
import static io.elves.common.util.Http2Util.toInt;
...
public class DispatchHttp2RequestHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
